...
function(check_git_repo_has_ns3_tags HAS_TAGS GIT_VERSION_TAG)
    execute_process(COMMAND ${GIT} describe --tags --abbrev=0 --match ns-3.[0-9]*
...
function(check_ns3_closest_tags CLOSEST_TAG VERSION_TAG_DISTANCE VERSION_COMMIT_HASH VERSION_DIRTY_FLAG)
    ...
    # Split ns-3.<version>.<patch>(-RC<digit>)-distance-commit(-dirty)
    # into a list ns;3.<version>.<patch>;(RC<digit);distance;commit(;dirty)
