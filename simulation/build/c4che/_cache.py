...
NS3_EXECUTABLE_PATH = ['/mnt/hgfs/HPCC/simulation/build/src/emu', '/mnt/hgfs/HPCC/simulation/build/src/tap-bridge']
...
NS3_MODULE_PATH = ['/usr/lib/gcc/x86_64-linux-gnu/4.8', '/mnt/hgfs/HPCC/simulation/build']
...
cfg_files = ['/mnt/hgfs/HPCC/simulation/build/ns3/config-store-config.h', '/mnt/hgfs/HPCC/simulation/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
