...
NS3_EXECUTABLE_PATH = ['/mnt/hgfs/High-Precision-Congestion-Control-master/simulation/build/src/emu', '/mnt/hgfs/High-Precision-Congestion-Control-master/simulation/build/src/tap-bridge']
...
NS3_MODULE_PATH = ['/usr/lib/gcc/x86_64-linux-gnu/4.8', '/mnt/hgfs/High-Precision-Congestion-Control-master/simulation/build']
...
cfg_files = ['/mnt/hgfs/High-Precision-Congestion-Control-master/simulation/build/ns3/config-store-config.h', '/mnt/hgfs/High-Precision-Congestion-Control-master/simulation/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
